 ...
 * Dialog for a user input with an autocomplete text field.
 */

public class AutoCompleteInputDialogFragment extends DialogFragment implements View.OnClickListener {
    ...
    public AutoCompleteInputDialogFragment() {}

    public static AutoCompleteInputDialogFragment newInstance(String title, String[] categoryNames,
                                                              InputDialogReceiver receiver, String startStr) {
        AutoCompleteInputDialogFragment fragment = new AutoCompleteInputDialogFragment();
        fragment.setStyle(DialogFragment.STYLE_NORMAL, android.R.style.Theme_Material_Light_Dialog);
        fragment.title         = title;
        fragment.categoryNames = categoryNames;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.dialog_input_autocomplete, container, false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        tvInput = (AutoCompleteTextView) view.findViewById(R.id.input_dialog_input);
